...
public class NoticeViewController {
    ...
    public String getNoticeList(@PageableDefault(size = 5) Pageable pageable,
                               Model model,
        ...
        return "page/boards/noticeList.html";
    }
    ...
    public String getNotice(@PathVariable Long postNo,
        ...
        return "page/boards/notice.html";
    }


    // 게시물 작성
    @GetMapping("/lms/new-notice")
